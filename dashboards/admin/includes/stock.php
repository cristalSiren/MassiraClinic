...
// Ensure the user is logged in and has access to the stock management system
...
include 'db2.php';  // Updated path to db2.php
require 'AdminController.php'; // Updated path to AdminController.php
...
<body>
    <div class="content-container">
        <!-- Sidebar -->
        <div class="sidebar">
            <?php include 'sidebarAd.php'; ?> <!-- Updated path to sidebar -->
        </div>
        ...
        <div class="main-content">
            ...
            <div class="flex justify-between mb-4">
                <form action="export_stock.php" method="post"> <!-- Updated path to export_stock.php -->
                    <input type="hidden" name="search" value="<?php echo htmlspecialchars($searchQuery); ?>">
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded-lg">Exporter vers Excel</button>
                </form>
                <form action="import_stock.php" method="post" enctype="multipart/form-data"> <!-- Updated path to import_stock.php -->
